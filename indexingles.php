        ...
        <div id="sliderindex">
            ...
            (function ($) {
                ...
                var config = {
                    ...
                    interval: 7500 // slideshow interval
                };
                // ==================================================================================
        ...
        <div id="resumo">
            <a href="trabalheconosco.php">
                <div class="artigo">
                    ...
                    <div class="texArt">
                        <h3>Work with Us</h3>
                        <br>
                        <p>Fill our curriculum <br>online!</p>
                    </div>
                </div>
            </a>
            <a href="sobre.php">
                <div class="artigo">
                    ...
                    <div class="texArt">
                        ...
                        <br>
                        <p>Know more about how everything started!</p>
                    </div>
                </div>
            </a>
            <a href="sustentabilidade.php">
                <div class="artigo">
                    ...
                    <div class="texArt">
                        <h3>Think more in the future</h3>
                        <br>
                        <p>Learn how to discard electronic waste!</p>
                    </div>
                </div>
            </a>
        </div>
